...
Route::prefix('post')->controller(PostController::class)->group(function () {
    ...
    Route::get('/{postId}/edit', 'edit')->name('news.edit')              ->middleware('checkrole:admin,salesman');
    Route::put('/{postId}', 'update')->name('news.update')               ->middleware('checkrole:admin,salesman');
    Route::delete('/news/{postId}/delete', 'delete')->name('news.delete')->middleware('checkrole:admin,salesman');
});